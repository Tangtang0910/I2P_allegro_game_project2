...
OUT:= game
SOURCE = main.cpp global.cpp GameController.cpp window/Window.cpp window/Menu.cpp window/DiningRoom.cpp window/Workshop.cpp
OBJ = main.o global.o GameController.o Window.o Menu.o DiningRoom.o Workshop.o
all: 
