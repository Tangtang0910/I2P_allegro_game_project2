...
OUT:= game
SOURCE = main.cpp global.cpp utils.cpp GameController.cpp Menu.cpp Dining_room.cpp workshop.cpp
OBJ = main.o global.o utils.o GameController.o Menu.o Dining_room.o workshop.o
all: 
