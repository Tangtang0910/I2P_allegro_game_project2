...
OUT:= game
SOURCE = main.cpp global.cpp GameController.cpp window/Window.cpp window/Menu.cpp window/DiningRoom.cpp
OBJ = main.o global.o GameController.o Window.o Menu.o DiningRoom.o
all: 
